    ...
    <section id='jobs' className='jobs'>
        ...
        <div className='job-card'>
          ...
          <div className='job-card__description-info'>
            ...
            <p>10/2019 - 12/2021</p>
            <p>Mis tareas principales, Full Stack Developer, incluían la actualización y desarrollo de nuevas funcionalidades de un Dashboard Web para la gestión de viajes, operadores, choferes y control vehicular
